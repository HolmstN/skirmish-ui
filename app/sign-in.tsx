...
export const SignIn = () => {
  return (
    <div className="flex justify-center">
      <button
        className="inline-flex w-1/3 justify-center rounded-md bg-white dark:bg-indigo-600 px-4 py-4 text-gray-500 dark:text-indigo-300 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-indigo-400 hover:bg-gray-50 dark:hover:bg-indigo-500 focus:outline-offset-0"
